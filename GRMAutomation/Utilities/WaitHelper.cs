...
namespace GRMAutomation.Utilities
{
    public static class WaitHelper
    {
        ...
        #region WaitForWebElementContentToLoad
        public static void WaitForElementContentToLoad(this IWebElement element, IWebDriver driver, string locator, int timeInSeconds)
        {
            int i = 0;
            while (i < 60)
            {
                driver.WaitTillVisibilityOfAllElements(locator, timeInSeconds);
        ...
        public static void WaitForElementContentToLoad(this IWebDriver driver, IWebElement element, string locator, int timeInSeconds)
        {
            int i = 0;
            while (i < 60)
            {
